...
class Video(Base):
    ...
    available_qualities = Column(Text, nullable=True)  # JSON array of available quality levels
    ...
    encoding_jobs = relationship("EncodingJob", back_populates="video", cascade="all, delete-orphan")
