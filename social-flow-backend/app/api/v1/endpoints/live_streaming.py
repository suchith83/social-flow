...
async def create_live_stream(
    ...
    try:
        result = await live_streaming_service.create_live_stream(
            str(current_user.id), title, description, tags, thumbnail_url
        )
        return result
...
async def get_live_stream(
    ...
    try:
        result = await live_streaming_service.get_live_stream(stream_id)
        return result
    except LiveStreamingServiceError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
...
async def get_live_streams(
    ...
    try:
        streams = await live_streaming_service.get_live_streams(limit, offset, status)
...
async def get_user_live_streams(
    ...
    try:
        streams = await live_streaming_service.get_user_live_streams(user_id, limit, offset)
        return {"streams": streams}
    except LiveStreamingServiceError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
...
async def update_live_stream(
    ...
    try:
        result = await live_streaming_service.update_live_stream(stream_id, updates)
        return result
    except LiveStreamingServiceError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
...
async def delete_live_stream(
    ...
    try:
        result = await live_streaming_service.delete_live_stream(stream_id)
        return result
    except LiveStreamingServiceError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
...
async def get_stream_viewers(
    ...
    try:
        viewers = await live_streaming_service.get_stream_viewers(stream_id)
...
async def record_viewer_join(
    ...
    try:
        result = await live_streaming_service.record_viewer_join(stream_id, str(current_user.id))
        return result
    except LiveStreamingServiceError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
...
async def record_viewer_leave(
    ...
    try:
        result = await live_streaming_service.record_viewer_leave(stream_id, str(current_user.id))
        return result
    except LiveStreamingServiceError as e:
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
