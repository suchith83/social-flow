...
class TestSubscriptions:
    ...
    async def test_get_current_subscription(
        ...
        create_response = await async_client.post(
            "/api/v1/subscriptions",
            json={"tier": "basic", "payment_method_id": "pm_test_002", "trial_days": 0},
            headers=headers,
        )
    ...
    async def test_upgrade_subscription(
        ...
        create_response = await async_client.post(
            "/api/v1/subscriptions",
            json={"tier": "basic", "payment_method_id": "pm_test_003", "trial_days": 0},
            headers=headers,
        )
        subscription_id = create_response.json()["id"]
    ...
    async def test_cancel_subscription(
        ...
        create_response = await async_client.post(
            "/api/v1/subscriptions",
            json={"tier": "premium", "payment_method_id": "pm_test_006", "trial_days": 0},
            headers=headers,
        )
        subscription_id = create_response.json()["id"]
    ...
    async def test_cancel_subscription_immediately(
        ...
        create_response = await async_client.post(
            "/api/v1/subscriptions",
            json={"tier": "basic", "payment_method_id": "pm_test_007", "trial_days": 0},
            headers=headers,
        )
        subscription_id = create_response.json()["id"]
    ...
    async def test_cannot_create_duplicate_subscription(
        ...
        await async_client.post(
            "/api/v1/subscriptions",
            json={"tier": "basic", "payment_method_id": "pm_test_008", "trial_days": 0},
            headers=headers,
        )
        ...
        response = await async_client.post(
            "/api/v1/subscriptions",
            json={"tier": "premium", "payment_method_id": "pm_test_009", "trial_days": 0},
            headers=headers,
        )
